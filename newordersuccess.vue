    ...
    methods: {
      runAdScript () {
        ...
        if (typeof window !== 'undefined' && this.orderDetails !== '') {
          ...
          //   console.log(order, 'order faied details');
          //   gtag(
          //     'event', 'order_failed',
          //     'ecommerce', {
          //       'orderfailed':[{
          //         'event_category': 'Order',
          //         'event_label': 'Order Failed '
          //       }]
          //   // You can add any additional data related to the order_failed if needed
          //   })
          // }
          const eventData = {
        'ecommerce': {
          'order_failed': {
            'event_category': 'Order',
            'event_label': 'Order Failed '
              // You can add any additional data related to the order_cancelled if needed
          }
        },
      };
